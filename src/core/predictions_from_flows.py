...
if __name__ == "__main__":
    ...
    main(video_indices=[0,1,2,3,4], config=config, run_name="5_7", mean_point_run_name=mean_point_run_name, is_mean_point_used=is_mean_point_used) 