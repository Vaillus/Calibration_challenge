...
def analyze_precision_loss(video_num: int, n_frames: int = 20):
    # Obtenir les chemins des fichiers
    flow_file = get_flows_dir() / f"{video_num}.npy"
    ...
    # output_file_16 = get_analysis_output_path(flow_file, '_float16_sample')
    # output_file_8 = get_analysis_output_path(flow_file, '_float8_sample')
...
if __name__ == "__main__":
    analyze_precision_loss(video_num=0, n_frames=20) 